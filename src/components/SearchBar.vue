<template>
    <main>
        <form class="md:hidden flex items-center mt-4 mx-3">
            ...
            <button type="submit"
                class="p-2.5 ms-2 text-sm font-medium text-white bg-orange-500 rounded-lg border border-greem-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
